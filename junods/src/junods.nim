...
let patch_drum = @[
  CMA(    0x00000000, "patch",
    CMA(    0x000000, "common",
      ...
      CMA(  0x002000, "tone",
        CMA(0x000000, "1", patch_tone_n),
        CMA(0x000200, "2", patch_tone_n),
        CMA(0x000400, "3", patch_tone_n),
        CMA(0x000600, "4", patch_tone_n),
      ),
    ),
  ),
  CMA(    0x00100000, "drum",
...
let juno_map = CMAO("",
  ...
  CMA(  0x10000000, "temporary",
    CMA(0x00000000, "performance_pattern",
        CMA(0x0000, "common",
          CM( 0x00, "name", TName),
          CM( 0x0c, "solo", TBool),
    ...
    CMA(  0x0e110000, "arpeggio",
    ),
    CMA(  0x0e130000, "rhythm_group",
    ),
